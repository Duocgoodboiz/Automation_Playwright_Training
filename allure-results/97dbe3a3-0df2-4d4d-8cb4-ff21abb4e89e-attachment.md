...
- Name: tc_07_checkout_error_handling.spec.ts >> TC_07 - Ensure proper error handling when mandatory fields are blank
- Location: tests/tc_07_checkout_error_handling.spec.ts:3:5
...
Call log:
  - waiting for locator('.woocommerce-error') to be visible
    ...
    - generic [ref=f6e5]:
      - generic [ref=f6e6]:
        ...
        - generic [ref=f6e143]:
          ...
          - link "3 Order status":
            - /url: "#"
          - generic [ref=f6e145]: 🔥 Hurry up, these products are limited, checkout within 14:42
        - generic [ref=f6e151]:
          - generic [ref=f6e152]:
            - generic [ref=f6e154]:
              ...
              - generic [ref=f6e164]:
                ...
                - generic [ref=f6e166]:
                  ...
                  - paragraph [ref=f6e179]:
                    ...
                    - generic [ref=f6e181]:
                      ...
                      - combobox "Country / Region" [ref=f6e185] [cursor=pointer]:
                        - textbox "United States (US)" [ref=f6e186]
                  ...
                  - paragraph [ref=f6e196]:
                    - generic [ref=f6e197]: Town / City *
                    - textbox "Town / City *" [ref=f6e199]:
                      - /placeholder: ""
                  - paragraph [ref=f6e200]:
                    - generic [ref=f6e201]: State *
                    - generic [ref=f6e202]:
                      - combobox [ref=f6e203] [cursor=pointer]
                      - combobox "State" [ref=f6e206] [cursor=pointer]:
                        - textbox "California" [ref=f6e207]
                  - paragraph [ref=f6e208]:
                    - generic [ref=f6e209]: ZIP Code *
                    - textbox "ZIP Code *" [ref=f6e211]:
                      - /placeholder: ""
                  - paragraph [ref=f6e212]:
                    - generic [ref=f6e213]: Phone *
                    - textbox "Phone *" [ref=f6e215]:
                      - /placeholder: ""
                  - paragraph [ref=f6e216]:
                    - generic [ref=f6e217]: Email address *
                    - textbox "Email address *" [ref=f6e219]:
                      - /placeholder: ""
                - paragraph [ref=f6e221]:
                  - generic [ref=f6e222]:
                    - checkbox "Create an account?" [ref=f6e223]
                    - text: Create an account?
              - paragraph [ref=f6e227]:
                - generic [ref=f6e228]: Order notes (optional)
                - textbox "Order notes (optional)" [ref=f6e230]:
                  - /placeholder: Notes about your order, e.g. special notes for delivery.
            - generic [ref=f6e232]:
              - heading "Your order" [level=3] [ref=f6e233]
              - generic [ref=f6e234]:
                - table [ref=f6e235]:
                  - rowgroup [ref=f6e236]:
                    - row [ref=f6e237]:
                      - cell [ref=f6e238]:
                        ...
                        - strong [ref=f6e239]: × 1
                      - cell "$290.00" [ref=f6e240]
                  - rowgroup [ref=f6e243]:
                    - row [ref=f6e244]:
                      - rowheader "Subtotal" [ref=f6e245]
                      - cell "$290.00" [ref=f6e246]
                    - row [ref=f6e249]:
                      - rowheader "Total" [ref=f6e250]
                      - cell "$290.00" [ref=f6e251]:
                        - strong [ref=f6e252]:
                          - generic [ref=f6e253]: $290.00
                - generic [ref=f6e255]:
                  - list [ref=f6e256]:
                    - listitem [ref=f6e257]:
                      - radio "Direct bank transfer" [checked] [ref=f6e258]
                      - generic [ref=f6e259]: Direct bank transfer
                      - paragraph [ref=f6e261]: Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.
                    - listitem [ref=f6e262]:
                      - radio "Check payments" [ref=f6e263]
                      - generic [ref=f6e264]: Check payments
                    - listitem [ref=f6e265]:
                      - radio "Cash on delivery" [ref=f6e266]
                      - generic [ref=f6e267]: Cash on delivery
                  - generic [ref=f6e268]:
                    - paragraph [ref=f6e271]:
                      ...
                      - link "privacy policy" [ref=f6e272] [cursor=pointer]:
                        - /url: https://demo.testarchitect.com/?page_id=3
                      - text: .
                    - button "Place order" [ref=f6e273] [cursor=pointer]
        - contentinfo [ref=f6e274]
      - generic [ref=f6e288]:
        - contentinfo [ref=f6e289]:
          - generic [ref=f6e296]:
            - img "talogoblue" [ref=f6e301]
            - generic [ref=f6e307]:
              - link "About Us" [ref=f6e308] [cursor=pointer]:
                - /url: /about-us/
              - link "Shop" [ref=f6e309] [cursor=pointer]:
                - /url: /shop/
              - link "Offers" [ref=f6e310] [cursor=pointer]:
                - /url: /electronic-components-supplies/
              - link "Blog" [ref=f6e311] [cursor=pointer]:
                - /url: /blog/
              - link "Contact Us" [ref=f6e312] [cursor=pointer]:
                - /url: /contact/
        - generic [ref=f6e313]: Copyright © 2021 LogiGear Corporation. All rights reserved.
    - generic [ref=f6e323] [cursor=pointer]: 
  - generic [ref=f6e327]: widescreen
  - dialog "Cookie Notice" [ref=f6e328]:
    - generic [ref=f6e329]:
      - generic [ref=f6e330]: We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.
      - link "Ok" [ref=f6e332] [cursor=pointer]:
        - /url: "#"
      - generic "No" [ref=f6e333] [cursor=pointer]
```
