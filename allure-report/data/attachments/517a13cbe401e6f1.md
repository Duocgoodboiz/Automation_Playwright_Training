...
- generic [active] [ref=f4e1]:
  ...
  - generic [ref=f4e4]:
    ...
    - generic [ref=f4e321] [cursor=pointer]: 
  - generic [ref=f4e325]: widescreen
  - dialog "Cookie Notice" [ref=f4e326]:
    - generic [ref=f4e327]:
      - generic [ref=f4e328]: We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.
      - link "Ok" [ref=f4e330] [cursor=pointer]:
        - /url: "#"
      - generic "No" [ref=f4e331] [cursor=pointer]
```
