...
- Name: tc_03_payment_methods.spec.ts >> TC_03 - Verify user can buy item using Cash on delivery
...
- generic [active] [ref=f6e1]:
  ...
  - generic [ref=f6e4]:
    - generic [ref=f6e5]:
      - generic [ref=f6e6]:
        ...
        - generic [ref=f6e143]:
          ...
          - link "3 Order status":
            - /url: "#"
          - generic [ref=f6e145]: 🔥 Hurry up, these products are limited, checkout within 14:20
        - generic [ref=f6e151]:
          - generic [ref=f6e152]:
            - generic [ref=f6e154]:
    ...
    - generic [ref=f6e315]:
      ...
      - generic [ref=f6e319]:
        - link [ref=f6e320] [cursor=pointer]:
          - /url: https://demo.testarchitect.com/product/dji-mavic-pro-camera-drone/
          - img "DJI Mavic Pro Camera Drone" [ref=f6e321]
        - generic [ref=f6e322]:
          - generic [ref=f6e323]:
            - text: 👜
            - generic [ref=f6e324]:
              - text: Someone recently bought a
              - link "DJI Mavic Pro Camera Drone" [ref=f6e325] [cursor=pointer]:
                - /url: https://demo.testarchitect.com/product/dji-mavic-pro-camera-drone/
          - generic [ref=f6e326]:
            - generic [ref=f6e327]: 16 minutes ago
            - generic [ref=f6e328]: from Colombo, Sri Lanka 🇱🇰
          - generic [ref=f6e329]: $129.00
          - link "View product " [ref=f6e333] [cursor=pointer]:
            - /url: https://demo.testarchitect.com/product/dji-mavic-pro-camera-drone/
    - generic [ref=f6e335] [cursor=pointer]: 
  - generic [ref=f6e339]: widescreen
  - dialog "Cookie Notice" [ref=f6e340]:
    - generic [ref=f6e341]:
      - generic [ref=f6e342]: We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.
      - link "Ok" [ref=f6e344] [cursor=pointer]:
        - /url: "#"
      - generic "No" [ref=f6e345] [cursor=pointer]
```
