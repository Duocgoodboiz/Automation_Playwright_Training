    ...
    - generic [ref=f5e315]:
      ...
      - generic [ref=f5e319]:
        - link [ref=f5e320] [cursor=pointer]:
          ...
          - img "Bose® 35 Wireless Headphones" [ref=f5e321]
        - generic [ref=f5e322]:
          - generic [ref=f5e323]:
            - text: 👜
            - generic [ref=f5e324]:
              - text: Someone recently bought a
              - link "Bose® 35 Wireless Headphones" [ref=f5e325] [cursor=pointer]:
                - /url: https://demo.testarchitect.com/product/bose-quietcomfort-35/
          - generic [ref=f5e326]:
            - generic [ref=f5e327]: 49 minutes ago
            - generic [ref=f5e328]: from Athens, Greece 🇬🇷
          - generic [ref=f5e329]:
            - deletion [ref=f5e330]:
              - generic [ref=f5e331]: $1,999.00
            - insertion [ref=f5e333]:
              - generic [ref=f5e334]: $1,000.00
          - link "View product " [ref=f5e337] [cursor=pointer]:
            - /url: https://demo.testarchitect.com/product/bose-quietcomfort-35/
    - generic [ref=f5e339] [cursor=pointer]: 
  - generic [ref=f5e343]: widescreen
  - dialog "Cookie Notice" [ref=f5e344]:
    - generic [ref=f5e345]:
      - generic [ref=f5e346]: We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.
      - link "Ok" [ref=f5e348] [cursor=pointer]:
        - /url: "#"
      - generic "No" [ref=f5e349] [cursor=pointer]
```
