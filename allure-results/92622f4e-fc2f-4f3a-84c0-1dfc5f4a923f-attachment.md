...
- generic [active] [ref=f4e1]:
    ...
    - generic [ref=f4e5]:
      - generic [ref=f4e6]:
        ...
        - generic [ref=f4e143]:
          ...
          - link "3 Order status":
            - /url: "#"
          - generic [ref=f4e145]: 🔥 Hurry up, these products are limited, checkout within 14:40
        - generic [ref=f4e151]:
          - generic [ref=f4e152]:
            - generic [ref=f4e154]:
  ...
  - generic [ref=f4e319]: widescreen
  - dialog "Cookie Notice" [ref=f4e320]:
    - generic [ref=f4e321]:
      - generic [ref=f4e322]: We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.
      - link "Ok" [ref=f4e324] [cursor=pointer]:
        - /url: "#"
      - generic "No" [ref=f4e325] [cursor=pointer]
```
